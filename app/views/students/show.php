              ...
              <div class="bg-white shadow rounded-lg p-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input value="<?= $student['nis']?>" class="w-full px-4 py-2 border rounded-lg" type="text" id="name" placeholder="Masukkan nama" name="nis" readonly>
                    </div>
                    <div class="space-y-2">
                        <label class="block font-bold" for="class">Kelas</label>
                        <input value="<?= $student['class']?>" class="w-full px-4 py-2 border rounded-lg" type="text" id="name" placeholder="Masukkan nama" name="class" readonly>
                    </div>
                    <div class="space-y-2">
                        <label class="block font-bold" for="phone_number">No Telepon</label>
                        <input value="<?= $student['phone_number']?>" class="w-full px-4 py-2 border rounded-lg" type="text" id="name" placeholder="Masukkan nama" name="phone_number" readonly>
                    </div>
